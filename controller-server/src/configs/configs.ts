...
const serverConnectionSettings = connectionConfigs.default;
// serverConnectionSettings.INTERNAL_IP = results.en0[0];
serverConnectionSettings.INTERNAL_IP = results.wlan0[0];
